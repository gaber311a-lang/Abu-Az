  ...
  function viewAdmin() {
    ...
    return `
      ...
      <div class="security-panel">
        ...
        <div class="ok">● جلسة الإدارة نشطة (محلية)</div>
        <div class="warn">● التخزين: localStorage — ليس قاعدة بيانات إنتاج</div>
        <div>الزوار (عداد محلي): <strong>${state.visitorCount}</strong></div>
        <div class="log-list">
      ...
      <div class="card">
        ...
        ${phase === 1 ? `
          <div class="form-group">
            ...
            <input class="input" type="password" id="admin-pass" placeholder="••••••••" />
          </div>
  ...
  function bindAdminEvents() {
    ...
    if (passNext) {
      passNext.onclick = () => {
        ...
        if (!p) { toast("أدخل كلمة المرور"); return; }
        // أي كلمة مرور غير فارغة في المعاينة
        state._adminPhase = 2;
